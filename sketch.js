...
launch = new Launcher(stoneObj.body, {x:243,y:420})
...
function mouseDragged(){
 ...
 function keyPressed(){
if(keyCode===32){
 Matter.Body.setPosition(stoneObj.body, {x:243,y:420})
